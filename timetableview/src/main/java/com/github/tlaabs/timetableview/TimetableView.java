...
public class TimetableView extends LinearLayout {
    //2022-01-13 오상민
    //09시~24시까지 시간표 리스트 출력
    private static final int DEFAULT_ROW_COUNT = 17;  // 09~24시까지
    private static final int DEFAULT_COLUMN_COUNT = 6; // 월화수목금
    private static final int DEFAULT_CELL_HEIGHT_DP = 50;
    private static final int DEFAULT_SIDE_CELL_WIDTH_DP = 30;
    private static final int DEFAULT_START_TIME = 9; // 시작시간 09:00
